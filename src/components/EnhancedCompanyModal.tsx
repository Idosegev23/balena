  ...
  const handleScannedData = async (scannedData: any) => {
    ...
    if (scannedData.name || scannedData.email || scannedData.phone) {
      const newContact = {
        ...
        card_image_url: scannedData.cardImageUrl || null // Add business card image URL
      }
    ...
    setEditedCompany(updatedCompany)
    setMessage(`Business card scanned successfully! Contact information has been added.${scannedData.cardImageUrl ? ' Business card image saved.' : ''}`)
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-lg border-2 border-gray-200">
                  ...
                  <BusinessCardViewer companyId={company.id} />
                </div>
              </div>
            </div>
          )}
