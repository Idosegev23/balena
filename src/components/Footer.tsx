...
export function Footer({ activeTab, onTabChange, onQuickAdd }: FooterProps) {
  ...
  return (
    <>
      ...
      <button
        onClick={onQuickAdd}
        className="fixed bottom-20 right-4 w-14 h-14 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 z-50 flex items-center justify-center active:scale-95"
        ...
        <div className="grid grid-cols-4 h-16">
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                {isActive && (
                  <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-8 h-0.5 bg-current rounded-full" />
                )}
